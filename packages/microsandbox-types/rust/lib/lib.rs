...
pub use domain::{
    ...
    HostPattern, HostPermissions, InterceptCaConfig, InterceptConfig, InterceptRule,
    InterfaceOverrides, LogSource, MAX_SECRET_FILE_BYTES, MAX_SECRET_PLACEHOLDER_BYTES,
    MemoryPlacement, MountOptions, NamedVolumeCreate, NamedVolumeMode, NetworkPolicy,
    NetworkRateLimitDirection, NetworkRateLimiterConfig, NetworkSpec, NumaPlacement,
    ...
    VolumeSpec, VsockRouteSpec, VsockSocketType, VsockSpec, canonicalize_volume_mounts,
};
