...
impl DnsForwarder {
    ...
    pub(crate) async fn forward(
        ...
        // Forward upstream. hickory-net's multiplexer assigns its own
        ...
        // Preserve the guest's transaction id. Since hickory 0.26 the
        // header fields live on `Message::metadata`, so set the id there.
